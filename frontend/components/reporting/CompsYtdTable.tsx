  ...
  return (
    <div className="space-y-3">
      <p className="text-[11px] text-white/40">
        ...
        la línea <span className="text-amber-300">Comps</span> del ancla de Tab 6.6 = 243 RN / 346 Pax); Jul en
        adelante se <span className="text-emerald-300">actualiza solo con la ingesta diaria</span> (cada comp cae en
